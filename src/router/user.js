...
const { loginSchema, registerSchema, getCountriesSchema, getCitiesSchema } = require('../schema/UserSchema')
const { login, register, getCities, getCountries } = require('../controller/userController')
...
router.get('/mysurveys', [tokenControl, userControl, yupValidate(mySurveysSchema)], usersurveys)
